...
struct InventoryItem: Identifiable, Codable, Equatable, Hashable {
    ...
    static let catalog: [InventoryItem] = [
        InventoryItem(id: "fish_biscuit", name: "Fish biscuit", category: .food, symbolName: "fish.fill", quantity: 3, satietyBoost: 22, moodBoost: 6, energyDelta: 2),
        InventoryItem(id: "crumb_cake", name: "Crumb Cake", category: .food, symbolName: "cup.and.saucer.fill", quantity: 3, satietyBoost: 28, moodBoost: 4, energyDelta: 2),
        InventoryItem(id: "berry_cube", name: "Berry Cube", category: .food, symbolName: "cube.fill", quantity: 2, satietyBoost: 18, moodBoost: 8, energyDelta: 0),
        InventoryItem(id: "glow_pellet", name: "Glow Pellet", category: .food, symbolName: "circle.hexagongrid.fill", quantity: 2, satietyBoost: 12, moodBoost: 12, energyDelta: 4),
